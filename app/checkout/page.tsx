                    ...
                    <motion.div variants={fadeUp} className="mt-3">
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className="pl-8 h-12 rounded-xl border-gray-200 bg-gray-50 focus:bg-white transition-colors placeholder:text-gray-300 text-black"
                        />
                      </div>
                    </motion.div>
                  </motion.div>
                  ...
                  <motion.div variants={stagger} initial="initial" animate="animate" className="space-y-5">
                    <motion.div variants={fadeUp} className="space-y-2">
                      ...
                      <Input
                        ...
                        className="h-12 rounded-xl border-gray-200 bg-gray-50 focus:bg-white transition-colors placeholder:text-gray-300 text-black"
                      />
                    </motion.div>
                    ...
                    <motion.div variants={fadeUp} className="space-y-2">
                      ...
                      <Textarea
                        ...
                        className="h-20 rounded-xl border-gray-200 bg-gray-50 focus:bg-white transition-colors placeholder:text-gray-300 resize-none text-black"
                      />
                    </motion.div>
                  </motion.div>
